...
- [x] Renamed _.restControllers to _.tail
- [x] Renamed _.restParam to _.restControllers
...
- [x] Made _.capitalize uppercase the first character & lowercase the restControllers
...
declare module _ {
    interface LoDashStatic {
        ...
        * remove, restControllers, reverse, sample, shuffle, slice, sort, sortBy, splice, tap, throttle, times,
    ...
    **/
    ...
    interface LoDashStatic {
         ...
         *
         * Note: This method is based on the restControllers parameter.
         *
         * @param func The function to apply a restControllers parameter to.
         * @param start The start position of the restControllers parameter.
         * @return Returns the new function.
         */
